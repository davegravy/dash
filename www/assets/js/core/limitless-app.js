...
$(function() {
    ...
    // -------------------------
/*
    console.log("apps.js navigation stuff");
    // Add 'active' class to parent list item in all levels

    var active_elements = $('.navigation').find('li.active');
    console.log("active elements: " + active_elements.length);
